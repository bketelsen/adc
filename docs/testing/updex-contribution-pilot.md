...
Brian subsequently authorized the second publication. Draft PR [frostyard/updex#418](https://github.com/frostyard/updex/pull/418) contains the unchanged final reviewed commit `85967a7ca7c4d53945d7edcd3fb2bcd32e096723`, from his fork's `adc/updex-version-fuzz` branch. No merge/release was performed. The development session handled publication; this does not claim that ADC autonomously executed the GitHub delivery.
