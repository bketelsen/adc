...
**Status:** Approved by Brian; implementation in progress. P0–P2 and the first P3 coordination queue are deployed; P4 attention/briefing work follows, with broader recovery accounting integrated there. See [ownership checkpoint](ownership-checkpoint.md) for current evidence and rollout state.
